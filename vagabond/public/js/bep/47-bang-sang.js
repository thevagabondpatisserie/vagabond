...
function bsLo(x) {
  ...
  if (tong > 3) {
    ...
    html += '<details data-bslo><summary style="font-size:13.5px;color:#0B7C93;font-weight:600;padding:0 2px;cursor:pointer;min-height:44px;display:flex;align-items:center;list-style:none">Xem thêm ' + (tong - 3) + ' lô nữa</summary>' +
