...
scheduler_events = {
	"cron": {
		...
		"15 * * * *": ["vagabond.ban_hang.bu_hddt_tu_dong"],
		# v527: ba nhip vet hoa don cua hom nay truoc nua dem, doi khoa lau
		# hon nhip bu. Xem ban_hang.bu_truoc_nua_dem.
		"25,40,52 23 * * *": ["vagabond.ban_hang.bu_truoc_nua_dem"],
		...
		"10,40 * * * *": ["vagabond.ban_hang.xuat_rai_trong_ngay_tu_dong"],
...
doc_events = {
	...
	"Task": {"before_validate": "vagabond.phan_tich.kiem_nguoi_sua_task", "validate": "vagabond.phan_tich.kiem_task",
		"on_update": "vagabond.phan_tich.dong_todo_khi_huy"},
