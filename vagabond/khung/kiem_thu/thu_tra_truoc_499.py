# -*- coding: utf-8 -*-
"""#499: phiếu trả trước vào bước kế bằng NÚT của workflow, không gán tay.
...
@ca("#499: đẩy bước bằng đúng nút Gửi kiểm tra, không gán tay trạng thái")
def _day_dung_nut():
	pe = Phieu(tt.TT_NHAP)
	goi = []
...
@ca("#499: đẩy bước hỏng thì GIỮ phiếu ở Nháp, không ném lỗi ra ngoài")
...
@ca("#499: hệ chưa có workflow thì không gọi apply_workflow, giữ nguyên bước")
...
@ca("#499: tao_phieu LƯU phiếu ở Nháp rồi mới đẩy bước, đúng thứ tự đó")
...
@ca("#499: đẩy không được thì câu báo NÓI THẬT, không bảo là đã gửi")
...
@ca("#499: không còn chỗ nào tự gán workflow_state lên phiếu mới")
