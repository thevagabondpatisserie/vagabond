...
def _hom_nay():
	...
	dung("tờ hôm nay không bị đặt ngày chờ xuất", "if ngay_cu != hom_nay and _ngay(r.get(TRUONG_NGAY_XUAT)) != hom_nay:" in s)
...
def _chip():
	...
	dung("nút kéo trong Cài đặt", "vagabond.hddt_cho_xuat.keo_sang_hom_nay" in cd and "chay_thu: 1" in cd and "chay_thu: 0" in cd)
