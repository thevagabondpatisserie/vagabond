...
CUA_NGO = {
	...
	"ncc.py": ["bo_gan", "chi_tiet", "danh_sach", "gan", "gan_hang_loat", "luu_tai_khoan", "mon_chua_gan", "tai_khoan", "xuat_excel"],
	"sua_ma_hoa_don.py": ["lien_quan", "lua_chon", "sua"],
	...
	"pancake_sp.py": ["tao_tren_pancake", "doi_soat_luot"],
	...
	"phan_tich.py": ["bang_sang", "bo_qua", "cap_nhat_viec", "dem_trang_chu", "giao", "hien_lai", "nguoi_de_giao", "tinh_lai", "viec"],
	...
	# v507: chot kho diem ban. Cung de ra Material Issue nhu hai man tren,
