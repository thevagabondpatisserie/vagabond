...
2. Hàng còn hạn: chọn HSD gần nhất trước, dù nhập sau. Một lô thiếu thì lấy tiếp lô khác trong đúng kho. Lô không có HSD xếp sau lô có HSD. Không chọn theo chữ/số trong mã lô.
...
- Mở rộng cơ chế cảnh báo HSD từ bốn luồng sản xuất sang phiếu Stock Entry nhập/xuất/chuyển kho. Khi chốt chặn bật vẫn giữ chặn. Không tự tắt chốt trên site bằng patch.
