...
- [Issue294: cloud và lưu bàn giao](cong-viec/issue-294.md)
- [Mẫu bàn giao](mau-ban-giao.md)
- [Luồng cloud cần nghiệm thu](luong-cloud.md)

Thêm một dòng mục lục khi có issue mới. Mỗi tệp công việc mục tiêu dưới8KB;
...
Mốc main948952b: 47 tệp Markdown,356000byte tổng nội dung hiện tại, không
phải kích thước toàn lịch sử git hoặc hạn mức GitHub. Ví dụ1000 bản ghi8KB
là khoảng8MB nội dung, chưa tính lịch sử. Chưa cần VPS riêng cho ghi chú.
